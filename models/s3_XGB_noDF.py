...
def get_rmse_save_result (trials, best, X_train):
  ...
  joblib.dump(best_model, 'Model_s3_XGB_noDF_allfold_'+condition+'.joblib')
  ...
  result.to_csv('Hyper_s3_XGB_noDF_allfold_'+condition+'.csv', index=False)
...
file_list = ["train_scenario_3_fold_0.csv", 
             "train_scenario_3_fold_1.csv", 
             "train_scenario_3_fold_2.csv", 
             "train_scenario_3_fold_3.csv"]
...
save_path = "XXX/EPiC_2023/Modeling/XGBoost/s3/" 
os.chdir(save_path)

###### Hyperopt #######----------------------------------------------------
max_eval = 35 # number of iterations in hyperopt
